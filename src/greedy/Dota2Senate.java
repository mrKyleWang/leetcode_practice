...
public class Dota2Senate {
    ...
    /*
        ...
        示例 1：
            ...
            输出："Radiant"
            解释：
                第一个参议员来自 Radiant 阵营并且他可以使用第一项权利让第二个参议员失去权力，
    ...
    public void test() {
        String senate = "RD";
        Assert.assertEquals("Radiant", predictPartyVictory(senate));
    }

    @Test
    public void test2() {
        String senate = "RDD";
        Assert.assertEquals("Dire", predictPartyVictory(senate));
    }

    /**
     * 队列存储两队索引，每次取出索引，参议员会将对方阵营下一个最近的参议员禁止，然后自己参与下一轮
     */
